...
apt install -y samba-ad-dc krb5-user smbclient winbind auditd ldb-tools lynis audispd-plugins fail2ban sudo ufw dnsutils openssh-server iptables-persistent chronyd | tee -a "$LOG_FILE"
